...
public class AlerteEventController {
     ...
     * @param priorité je récupère le String du premier ChoiceBox (initializePriotityChoiceBox())
     * @return
     */
    public int IntPriorite(String priorité) {
        ...
        if (alertChoiceId.getValue() == null) {
            ...
            try {
                ...
                if (rs.next() == false) {
                    ...
                    String r = "insert into alerte (idutilisateur, idtache, priorité, ordrePriorite) values (?,?,?,?)";
                    ...
                    ps1.setInt(1, userid);
                    ps1.setInt(2, id);
                    ps1.setString(3, priorityId.getValue().toString());
                    ps1.setInt(4, IntPriorite(priorityId.getValue().toString()));
                    ps1.execute();
                    co.commit();
