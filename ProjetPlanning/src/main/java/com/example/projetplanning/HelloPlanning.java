...
public class HelloPlanning extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        //lie la page avec une page de cssHello
        scene.getStylesheets().add(getClass().getResource("stylePlanning.css").toExternalForm());
        //pour mettre une icone en haut de la page
        Image image = new Image("file:src/Image/ico-planning.png");
        stage.getIcons().add(image);
        //Change le nom visible de la page
        stage.setTitle("Planning");
        //empeche de changer la taille de la page que je vais ouvrir (Planning.fxml)
    ...
    static String uri = "jdbc:mysql://localhost:3306/planningprojet";
